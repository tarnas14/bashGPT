...
[[ -z "${OPEN_AI_ORGANIZATION_ID}"  ]] && OPEN_AI_ORGANIZATION_ID="IF_YOU_DONT_HAVE_A_ENV_VARIABLE_PUT_YOUR_OPEN_AI_ORGANIZATION_ID_HERE" || OPEN_AI_ORGANIZATION_ID="${OPEN_AI_ORGANIZATION_ID}"
...
# ---------------------------> Rofi <--------------------------- #
rofi_prompt() {
    echo "" | rofi -dmenu -location 0 -i --fixed-num-lines -width 70 -show-icons -show run -sidebar-mode
